...
import { BehaviorSubject, ReplaySubject, Subject, merge, defer, of, iif, from } from 'rxjs';
import { filter, distinctUntilChanged, switchMap, mergeMap, shareReplay, concatMap, catchError, tap, takeUntil, map, take, pluck, first } from 'rxjs/operators';
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(AuthClientConfig, [{
        type: Injectable,
...
AuthHttpInterceptor.ɵfac = function AuthHttpInterceptor_Factory(t) { return new (t || AuthHttpInterceptor)(ɵngcc0.ɵɵinject(AuthClientConfig), ɵngcc0.ɵɵinject(Auth0ClientService)); };
