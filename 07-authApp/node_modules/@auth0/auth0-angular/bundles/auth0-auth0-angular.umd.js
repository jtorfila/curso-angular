(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var useragent = { name: '@auth0/auth0-angular', version: '1.3.1' };
    ...
    var AuthService = /** @class */ (function () {
        function AuthService(auth0Client, configFactory, location, navigator) {
            ...
            this.isAuthenticatedTrigger$ = this.isLoading$.pipe(operators.filter(function (loading) { return !loading; }), operators.distinctUntilChanged(), operators.switchMap(function () {
                ...
                return rxjs.merge(rxjs.defer(function () { return _this.auth0Client.isAuthenticated(); }), _this.refreshState$.pipe(operators.mergeMap(function () { return _this.auth0Client.isAuthenticated(); })));
            }), 
        ...
        AuthService.prototype.getAccessTokenSilently = function (options) {
            var _this = this;
            return rxjs.of(this.auth0Client).pipe(operators.concatMap(function (client) { return client.getTokenSilently(options); }), operators.tap(function () { return _this.refreshState$.next(); }));
        };
        /**
         * ```js
        ...
        AuthService.prototype.getAccessTokenWithPopup = function (options) {
            var _this = this;
            return rxjs.of(this.auth0Client).pipe(operators.concatMap(function (client) { return client.getTokenWithPopup(options); }), operators.tap(function () { return _this.refreshState$.next(); }));
        };
